          ...
          child: ListView(
            children: [
              ...
              const ListTile(
                ...
                title: Text("Ordenes antiguas"),
              ),
              const ListTile(
                leading: Icon(Icons.location_city),
                title: Text("Modificar direcciòn"),
              ),
              const ListTile(
        ...
        child: StreamBuilder<QuerySnapshot>(
          ...
          builder:
            ...
            if (snapshot.hasError) {
              return const Text('Algo saliò mal');
                              ...
                              IconButton(
                                ...
                                onPressed: () async {
                                  if (FirebaseAuth.instance.currentUser !=
                                    ...
                                    print("Se agregò exitosamente al carrito");
                                  } else {
                                    Navigator.push(
                                      context,
                                      MaterialPageRoute(
